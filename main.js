...
function clicked() {
    ...
    document.getElementsByClassName("circle")[2].classList.toggle("bounce-right");
    if (toggle) {
...
function clickedMobile() {
    ...
    document.getElementsByClassName("section")[1].classList.toggle("bounce-left");
    document.getElementsByClassName("section")[2].classList.toggle("bounce-right");
    if (toggle) {
